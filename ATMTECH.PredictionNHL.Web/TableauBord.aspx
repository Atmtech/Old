            ...
            <div class="col">
                <asp:UpdatePanel runat="server" id="updatePanel">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <label class="font-weight-bold">Date de la prédiction</label>
                                ...
                                <table class="table table-dark table-hover table-striped">
                                    ...
                                    <asp:Repeater runat="server" ID="repeaterPrediction" OnItemCommand="repeaterPrediction_ItemCommand">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 25px;">
                                                <asp:TextBox runat="server"  style="text-align:center;font-size:35px;"  ID="txtPredictionPointageVisiteur" ReadOnly='<%# Convert.ToBoolean(Eval("EstDejaPredit")) ? true : false  %>' class="form-control  bg-dark text-white" Text='<%# Eval("PredictionPointageVisiteur").ToString() %>' onkeypress="return isNumberKey(event)"></asp:TextBox></td>
                                            <td>
                                            ...
                                            <td style="width: 25px;">
                                                <asp:TextBox runat="server" ID="txtPredictionPointageLocal" style="text-align:center;font-size:35px;" ReadOnly='<%# Convert.ToBoolean(Eval("EstDejaPredit")) ? true : false  %>' class="form-control  bg-dark text-white" Text='<%# Eval("PredictionPointageLocal").ToString() %>' onkeypress="return isNumberKey(event)"></asp:TextBox></td>
                                            <td>
