<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="GererNourriture.aspx.cs" Inherits="ATMTECH.Expeditn.WebSite.GererNourriture" %>
                    ...
                    <td>
                        <div>
                            ...
                            <asp:TextBox runat="server" ID="txtDateMenu" placeholder="Date"></asp:TextBox>
                             <div style="border-bottom:solid 1px gray"><asp:label ID="lblMenuDetaille" runat="server" Text="Menu"></asp:label></div>
                            <atmtech:Editor runat="server" ID="txtMenu" Toolbar="Basic" />
                            <div style="border-bottom:solid 1px gray"><asp:label ID="lblCuisinier" runat="server" Text="Cuisinier"></asp:label></div>
