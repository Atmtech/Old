<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ATMTECH.StockGame.Site.Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="view" ; background-repeat: no-repeat; background-size: cover; background-position: center center;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
                        ...
                        <hr class="hr-light">
                        <h6 class="mb-4 text-white">Un jeu simple avec la bourse. </h6>
                    ...
                    <div class="col-md-6 col-xl-5 mt-xl-5 wow fadeInRight" data-wow-delay="0.3s">
                        <img src="Images/stock.png" alt="" class="img-fluid w-50">
                    </div>
                </div>
            </div>
        </div>
