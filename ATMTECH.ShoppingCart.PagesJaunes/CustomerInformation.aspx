<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="CustomerInformation.aspx.cs" Inherits="ATMTECH.ShoppingCart.PagesJaunes.CustomerInformation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width: 950px; padding: 10px 10px 10px 10px; color: black; border: solid 1px gray; background-color: white; margin-bottom: 10px;">
        ...
        <div>
            <asp:Button runat="server" ID="btnSave" OnClick="SaveCustomer_click" Text="Enregistrer" style="background-color:#595959;" />
            <asp:Button runat="server" ID="btnChangePassword" OnClick="ChangePassword_click" style="background-color:#595959;"
