<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="ATMTECH.ShoppingCart.PagesJaunes.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlLogin" Visible="True" DefaultButton="btnSignIn">
        <div style="width: 950px; padding: 10px 10px 10px 10px; color: black; border: solid 1px gray; background-color: white; margin-bottom: 10px;">
            ...
            <br />
            <hr />
            <asp:Button runat="server" ID="btnSignIn" Text="Entrer" OnClick="SignInClick" style="background-color:#595959;"></asp:Button>
            <asp:Button runat="server" ID="btnCreateCustomer" Text="Créer un compte"  style="background-color:#595959;" OnClick="CreateCustomerClick"
                Visible="False" />
            <asp:Button runat="server" ID="btnForgetPassword"  style="background-color:#595959;" Text="J'ai oublié mon mot de passe"
