...
namespace ATMTECH.Test.Builder
{
    public static class UserBuilder
    {
        ...
        {
            return Create().WithFirstName("Vincent").WithLastName("Rioux").WithLogin("riov01").WithPassword("test").WithEmail("sagaan@hotmail.com").WithIsAdministrator(true);
        }
