<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ATMTECH.Expeditn.Site.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="view" style="background-image: url('https://www.publicdomainpictures.net/pictures/40000/velka/fishing-in-sunrise.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        <div class="mask rgba-gradient d-flex justify-content-center align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
                        <h1 class="h1-responsive font-weight-bold mt-sm-5 text-white">Bonjour. Voici Expedit'n</h1>
                        <hr class="hr-light">
                        <h6 class="mb-4 text-white">La planification d'expédition simple, efficace et connecté sur votre monde. Vous pourrez aussi faire le suivi de voyage, d'hotel ou de vol d'avion. </h6>
