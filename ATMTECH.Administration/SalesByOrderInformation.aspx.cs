...
{
    public partial class SalesByOrderInformation : PageBaseAdministration, ISalesByOrderInformationPresenter
    {
        public SalesByOrderInformationPresenter Presenter { get; set; }
