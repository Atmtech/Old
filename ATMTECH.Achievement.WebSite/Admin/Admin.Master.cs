...
namespace ATMTECH.Achievement.WebSite.Admin
{
    public partial class Admin : System.Web.UI.MasterPage
    {
        ...
        private void FillData()
        {
            ...
            BaseDao<ATMTECH.Entities.Parameter, int> daoParameter = new BaseDao<ATMTECH.Entities.Parameter, int>();
            ATMTECH.Entities.Parameter parameter1 = new ATMTECH.Entities.Parameter { Code = ParameterConstant.ADMIN_MAIL, Description = "test@test.com" };
            daoParameter.Save(parameter1);
            ATMTECH.Entities.Parameter parameter2 = new ATMTECH.Entities.Parameter { Code = ParameterConstant.MAIL_BODY_CONFIRM_CREATE, Description = @"Cliquer ici pour confirmer la création de votre compte:<br><br><a href='http:\\dev.sagacemarketing.com\ConfirmCreate.aspx?ConfirmCreate={0}'>Confirmer la création de mon compte</a>" };
            daoParameter.Save(parameter2);
            ATMTECH.Entities.Parameter parameter3 = new ATMTECH.Entities.Parameter { Code = ParameterConstant.MAIL_SUBJECT_CONFIRM_CREATE, Description = "Nouvelle demande de création de compte" };
            daoParameter.Save(parameter3);
            ATMTECH.Entities.Parameter parameter4 = new ATMTECH.Entities.Parameter { Code = ParameterConstant.MAIL_SUBJECT_FORGET_PASSWORD, Description = "Une demande d'oubli de mot de passe a été demandé." };
            daoParameter.Save(parameter4);
            ATMTECH.Entities.Parameter parameter5 = new ATMTECH.Entities.Parameter { Code = ParameterConstant.MAIL_BODY_FORGET_PASSWORD, Description = "Voici votre mot de passe: {0}" };
            daoParameter.Save(parameter5);

            BaseDao<Message, int> dao = new BaseDao<Message, int>();
            Message message1 = new Message { InnerId = Services.ErrorCode.ErrorCode.ACH_AUCUNE_QUALITE_ASSOCIE_ACCOMPLISSEMENT, Language = "fr", Description = "Aucune qualité associé" };
            dao.Save(message1);
