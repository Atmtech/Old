...
namespace ATMTECH.WPF.Themes
{
    public static class ThemeManager
    {
        public static ResourceDictionary GetThemeResourceDictionary(string theme)
        {
            if (theme != null)
            {
                Assembly assembly = Assembly.LoadFrom("ATMTECH.WPF.Themes.dll");
                string packUri = String.Format(@"/ATMTECH.WPF.Themes;component/{0}/Theme.xaml", theme);
